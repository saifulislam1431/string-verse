...
const Banner = () => {
    ...
    // https://i.ibb.co/P40fBHc/banner1.jpg
    // https://i.ibb.co/pnHFNYW/banner2.jpg
    // https://i.ibb.co/KDc9QVC/banner3.jpg
    // https://i.ibb.co/CJyrjD6/banner4.jpg
    // https://i.ibb.co/VmFyDNN/banner5.jpg
 ...
 <Carousel className='text-center' autoPlay={true} infiniteLoop={true} showThumbs={false}>
                <div className='relative'>
                    <img src="https://i.ibb.co/zHCrRJ0/banner1.jpg" className='h-96'/>
                ...
                <div className='relative'>
                    <img src="https://i.ibb.co/pnHFNYW/banner2.jpg" className='h-96'/>
                    <div className='absolute top-0 w-full h-full bg-primary bg-opacity-50 flex justify-center items-center'>
                ...
                <div className='relative'>
                    <img src="https://i.ibb.co/KDc9QVC/banner3.jpg" className='h-96'/>
                    <div className='absolute top-0 w-full h-full bg-primary bg-opacity-50 flex justify-center items-center'>
                ...
                <div className='relative'>
                    <img src="https://i.ibb.co/VmFyDNN/banner5.jpg" className='h-96'/>
                    <div className='absolute top-0 w-full h-full bg-primary bg-opacity-50 flex justify-center items-center'>
